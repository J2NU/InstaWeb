      ...
      <div class="container__center">
        ...
        <ul>
          <li>
            ...
            this Disclaimer) refers to Group 29, 702 Nguyễn Văn Linh, Tân Hưng,
          ...
          <li>
            <strong>Website</strong> refers to InstaKGram, accessible from
            <a
              href="https://www.instakgram.com"
              rel="external nofollow noopener"
              target="_blank"
              >https://www.instakgram.com</a
            >
          </li>
        </ul>
        <h1>Disclaimer</h1>
        ...
        <ul>
          <li>
            <p>By email: instakgram__service@gmail.com</p>
          </li>
          <li>
            <p>
